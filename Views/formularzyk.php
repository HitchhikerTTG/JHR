...
<div class="section">
	...
	<? echo form_open(base_url() . 'stworzOkno', ['method' => 'POST', 'onsubmit' => 'console.log("Formularz wysyłany!", this); console.log("Action URL:", this.action); console.log("Method:", this.method); return true;']); ?>
	<?=csrf_field()?>
