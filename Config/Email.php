...
class Email extends BaseConfig
{
    ...
    public function __construct()
    {
        ...
        $this->fromEmail = env('POSTMARK_FROM_EMAIL', 'johari@testujac.pl');
        ...
        $this->SMTPUser = env('email.SMTPUser', env('POSTMARK_SERVER_TOKEN', ''));
        $this->SMTPPass = env('email.SMTPPass', env('POSTMARK_SERVER_TOKEN', ''));
